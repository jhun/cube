...
var _DeviceOrientationManager = __webpack_require__(6);
...
var VZCubeElement = function (_HTMLElement) {
    ...
    function VZCubeElement() {
        ...
        _this.deviceOrientationManager = new _DeviceOrientationManager2.default(_this, true);
        return _this;
    }
    ...
    _createClass(VZCubeElement, [{
        ...
        value: function animateTo(yaw, pitch) {
            ...
            var direction = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'auto';
        ...
        value: function zoomTo(zoomValue) {
            ...
            this.style.transition = duration + 'ms perspective ease-in-out', this.style.perspective = zoomValue + 'vmax';
        }
    }, {
        key: 'fadeOut',
...
var DeviceOrientationManager = function () {
    function DeviceOrientationManager(cube) {
        var initOrientationCompensate = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    ...
    _createClass(DeviceOrientationManager, [{
        ...
        key: '_handleDeviceOrientationInit',
        value: function _handleDeviceOrientationInit(e) {
